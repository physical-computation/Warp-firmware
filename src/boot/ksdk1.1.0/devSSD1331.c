...
//Turns off the screen and then On again with a green colour
int devSSD1331Green(void)
{
  ...
  warpEnableSPIpins();
	...
	GPIO_DRV_SetPinOutput(kSSD1331PinRST);
	OSA_TimeDelay(100);
	//Add extra time delay. Increases the tim e that the OLED remains off
  OSA_TimeDelay(700);
	/*
...
//Turns off the screen and then On again with an orange colour
...
//Turns off the screen and then On again with a red colour
